# AGENTS.md — PointCraft project memory

Concise memory for Codex sessions. Read this first, then read the active
...
This repo is the **single source of truth** shared between Codex Chat (research
planning) and Codex (implementation). Chat history is NOT the source of

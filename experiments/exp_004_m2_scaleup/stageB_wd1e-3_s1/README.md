...
- best ckpt by held-out strict IoU @ epoch 20, p=0.7
...
|--------|----|----------|--------------|-----|------|
| strict | 0.146 | 0.165 | **0.305** | 0.165 | ✅ |
| mid | 0.091 | 0.134 | **0.193** | 0.134 | ✅ |
| tolerant | 0.087 | 0.141 | **0.194** | 0.141 | ✅ |

- **VERDICT A** — real generalization: held-out > max(B1,B3) on all 3 cutoffs.
- strict ratios: 1.849× B3 shell, 0.403× of the 0.7576 recall ceiling
- per-train-tile strict IoU at best ckpt: {'09LD1878': 0.0624, '09LD1845': 0.0619, '09LD1843': 0.2601, '09LD1867': 0.1283, '09LD2818': 0.3126, '09LD1846': 0.1767, '09LD1885': 0.1896, '09LD1886': 0.2913, '09LD1897': 0.2532, '09LD2807': 0.2479} (train≫held-out → memorized; both low → under-learned/bug)
